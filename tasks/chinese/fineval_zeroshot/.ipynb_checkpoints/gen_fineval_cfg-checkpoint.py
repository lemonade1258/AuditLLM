...
if __name__ == "__main__":
    ...
    args.base_yaml_path = "/root/autodl-tmp/update-finben/FinBen/tasks/chinese/fineval_zeroshot/_default_fineval_yaml"
    ...
    for subject_en, subject_zh in tqdm(SUBJECTS.items()):
        ...
        file_save_path = f"/root/autodl-tmp/update-finben/FinBen/tasks/chinese/fineval_zeroshot/{subject_en}.yaml"
